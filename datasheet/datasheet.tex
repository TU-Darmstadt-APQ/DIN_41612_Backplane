...
\begin{table}[h!]
    ...
    \begin{threeparttable}
        \begin{tabularx}{\textwidth}{l | c | X | c c c | c}
            ...
            & $I$ & (Note 1) & & & \num{\pm 12} & \unit{\A} \\
            \hline
            \multirow{2}{*}{Undervoltage threshold} & & (Note 2) & \num{6.3} & \num{6.5} & \num{6.7} & \unit{\V} \\
             & & (Note 1, 2) & \num{-9.8} & \num{-10.1} & \num{-10.8} & \unit{\V} \\
            \multirow{2}{*}{Undervoltage hysteresis} & &(Note 2) & \num{6.0} & \num{6.1} & \num{6.3} & \unit{\V} \\
             & & (Note 1, 2)  & \num{-8.8} & \num{-9.1} & \num{-9.2} & \unit{\V} \\
            \multirow{2}{*}{Overvoltage threshold} & & (Note 2) & \num{25.3} & \num{26.1}& \num{26.9} & \unit{\V} \\
             & & (Note 1, 2) & \num{-25.8} & \num{-26.6}& \num{-27.4} & \unit{\V} \\
            \multirow{2}{*}{Overvoltage hysteresis} & & (Note 2) & \num{24.7} & \num{25.3}& \num{26.0} & \unit{\V} \\
             & & (Note 1, 2) & \num{-24.3} & \num{-25.6}& \num{-26.9} & \unit{\V} \\
